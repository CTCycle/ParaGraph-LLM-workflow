...
- If startup reports a database migration failure, stop other ParaGraph instances, resolve the reported schema or file-lock problem, and rerun option 5. The migration runner fails closed and does not replace existing application tables.
...
Launcher option 11 removes the database, database sidecars, logs, downloaded
