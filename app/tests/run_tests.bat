...
set "TEST_TARGET=%APP_DIR%\tests\unit"
if exist "%TESTS_E2E_DIR%" set "TEST_TARGET=%APP_DIR%\tests"
...
if /i "%PARAGRAPH_ENABLE_LIVE_E2E_SERVERS%"=="true" if exist "%TESTS_E2E_DIR%" (
    ...
    if "!BACKEND_RUNNING!"=="0" (
        ...
        start "" /B /D "%APP_DIR%" "%PYTHON_CMD%" -m uvicorn server.app:app --host %FASTAPI_HOST% --port %FASTAPI_PORT%
